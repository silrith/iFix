<template>
  <div class="headerBanner">
    <div class="headerBannerLeftDiv">
      <div class="headerBannerLeftText">
        <div class="txt3">
        ...
        <div class="headerBannerSearchDiv">
          <div
        ...
        <div class="bannerLeftFooterText">
          <div class="footerTextDiv1">
            <p class="txt5">
              ...
              <span class="txt4" style="padding-left: 33px">Garantie</span>
            </p>
          </div>
          <div class="footerTextDiv2">
            <p class="txt5">
              faire <span style="color: #f26d25">Preise</span><br />
              <span class="txt4" style="padding-left: 33px"
                >Transparent & fix</span
              >
            </p>
          </div>
        </div>
    ...
    <div class="headerBannerRightDiv" style="margin-top: 30px">
      <div>
        <div class="headerBannerRightDivTop">
          <div>
            <img
...
.input103:focus + .focus-input103 + .symbol-input103 {
  color: white;
  padding-left: 15px;
  border: none;
}
...
.headerBannerLeftText {
  width: 80%;
}

.headerBannerSearchDiv {
  width: 80%;
  display: flex;
  flex-direction: row;
  align-items: center;
