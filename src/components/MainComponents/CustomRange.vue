...
export default {
  ...
  mounted() {
	...
	if(this.$route.query.filter == "brands"){
		...
		$(".input:eq(1)").addClass("active");
	}else if(parseInt(this.$route.query.modelFilter) > 0 ){
		$(".input:eq(1)").removeClass("active");
		$(".input:eq(2)").addClass("active");
	}else if(this.$route.query.brandFilter > 0 ){
