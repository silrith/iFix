...
const expander = document.querySelector(".dashboardContainer .menu .expander");
...
const date = document.querySelector(".dashboardContainer .side .date");
const time = document.querySelector(".dashboardContainer .side .time");
